...
module StreamChat
  ...
  class Client
    ...
    # @param [StringKeyDictionary] options extra options such as base_url
    #
    ...
    # @param [StringKeyDictionary] options extra options
    ...
    sig { params(filter_conditions: StringKeyDictionary, options: T.untyped).returns(StreamChat::StreamResponse) }
    ...
    sig { params(filter_conditions: StringKeyDictionary, query: T.any(String, StringKeyDictionary), sort: T.nilable(StringKeyDictionary), options: T.untyped).returns(StreamChat::StreamResponse) }
    ...
    sig { params(users: T::Array[StringKeyDictionary]).returns(StreamChat::StreamResponse) }
    ...
    sig { params(user: StringKeyDictionary).returns(StreamChat::StreamResponse) }
    def update_user(user)
      update_users([user])
    end

    sig { params(updates: T::Array[StringKeyDictionary]).returns(StreamChat::StreamResponse) }
    def update_users_partial(updates)
      patch('users', data: { users: updates })
    end

    sig { params(update: StringKeyDictionary).returns(StreamChat::StreamResponse) }
    ...
    sig { params(message: StringKeyDictionary).returns(StreamChat::StreamResponse) }
    ...
    sig { params(message_id: String, updates: StringKeyDictionary, user_id: T.nilable(String), options: T.untyped).returns(StreamChat::StreamResponse) }
    ...
    sig { params(filter_conditions: StringKeyDictionary, sort: T.nilable(StringKeyDictionary), options: T.untyped).returns(StreamChat::StreamResponse) }
    ...
    sig { params(data: StringKeyDictionary).returns(StreamChat::StreamResponse) }
    ...
    # @param [StringKeyDictionary] data additional channel data
    #
    # @return [StreamChat::Channel]
    #
    sig { params(channel_type: String, channel_id: T.nilable(String), data: T.nilable(StringKeyDictionary)).returns(StreamChat::Channel) }
    ...
    sig { params(user_id: String, event: StringKeyDictionary).returns(StreamChat::StreamResponse) }
    ...
    sig { params(message_id: String, data: StringKeyDictionary).returns(StreamChat::StreamResponse) }
    ...
    sig { params(name: String, words: StringKeyDictionary).returns(StreamChat::StreamResponse) }
    ...
    sig { params(channels: StringKeyDictionary, options: T.untyped).returns(StreamChat::StreamResponse) }
    ...
    sig { params(user_ids: T::Array[String], user: String, messages: T.nilable(StringKeyDictionary), conversations: T.nilable(String)).returns(StreamChat::StreamResponse) }
    ...
    sig { params(relative_url: String, params: T.nilable(StringKeyDictionary), data: T.nilable(StringKeyDictionary)).returns(StreamChat::StreamResponse) }
    ...
    sig { params(relative_url: String, params: T.nilable(StringKeyDictionary)).returns(StreamChat::StreamResponse) }
    ...
    sig { params(relative_url: String, file_url: String, user: StringKeyDictionary, content_type: T.nilable(String)).returns(StreamChat::StreamResponse) }
    ...
    sig { params(push_data: StringKeyDictionary).returns(StreamChat::StreamResponse) }
    ...
    sig { params(command: StringKeyDictionary).returns(StreamChat::StreamResponse) }
    ...
    sig { params(name: String, command: StringKeyDictionary).returns(StreamChat::StreamResponse) }
    ...
    sig { params(permission: StringKeyDictionary).returns(StreamChat::StreamResponse) }
    def create_permission(permission)
      post('permissions', data: permission)
    end

    sig { params(id: String, permission: StringKeyDictionary).returns(StreamChat::StreamResponse) }
    ...
    sig { params(method: Symbol, relative_url: String, params: T.nilable(StringKeyDictionary), data: T.nilable(StringKeyDictionary)).returns(StreamChat::StreamResponse) }
