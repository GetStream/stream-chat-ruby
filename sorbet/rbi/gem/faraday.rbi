...
module Faraday
  ...
  class UploadIO
    sig { params(filename_or_io: T.any(String, IO), content_type: String, filename: T.nilable(String), opts: Hash).void }
    def initialize(filename_or_io, content_type, filename = nil, opts = {}); end
  end
  ...
  class Connection
    ...
    def run_request(method, url, body, headers, &block); end
