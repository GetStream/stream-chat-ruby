...
- Your app has push notifications configured for at least one provider [in your app settings](/chat/docs/ruby/app_setting_overview/)

- You have a user that has at least one [device](/chat/docs/ruby/#push_devices/) associated
...
client.check_push({ message_id: message_id, skip_devices: true, user_id: user[:id] })
```
