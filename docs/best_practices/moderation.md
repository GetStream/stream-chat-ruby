...
For more details on permissions, see [User Permissions](/chat/docs/ruby/chat_permission_policies/).
...
For more details, see [App Settings](/chat/docs/ruby/app_setting_overview/).
...
For more details, see [Slow Mode & Throttling](/chat/docs/ruby/slow_mode/).
