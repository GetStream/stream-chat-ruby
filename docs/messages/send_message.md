...
> [!WARNING]
> Deleting a message does not delete its file attachments. See [deleting attachments](/chat/docs/ruby/file_uploads/#deleting-files-and-images/) for more information.
