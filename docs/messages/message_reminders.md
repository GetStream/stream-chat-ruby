...
Reminders require Push V3 to be enabled - see details [here](/chat/docs/ruby/push_template/)
...
These webhook events contain the same payload structure as their WebSocket counterparts. For more information on configuring webhooks, see the [Webhooks documentation](/chat/docs/ruby/webhook_events/).
