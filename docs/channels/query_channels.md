...
> [!NOTE]
> For supported query operators, see [Query Syntax Operators](/chat/docs/ruby/query_syntax_operators/).
...
For the full list of supported query operators, see [Query Syntax Operators](/chat/docs/ruby/query_syntax_operators/).
