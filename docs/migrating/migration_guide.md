...
**Step 3b: Prepare Import File.** The [import section](/chat/docs/ruby/import/) has the full details. First practice with a small import.
...
**Step 4: Final Import.** Next, [Import](/chat/docs/ruby/import/) all historical data.
...
2. Export chat data in Stream's [import format](/chat/docs/ruby/import/)
...
2. Review the [Importing Data](/chat/docs/ruby/import/) guide
