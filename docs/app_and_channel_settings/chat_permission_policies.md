...
- **Application Permissions** : You can grant these using the .app scope. These permissions apply to operations that occur outside of channel-types including accessing and [modifying other users](/chat/docs/ruby/update_users/), or [using moderation features](/chat/docs/ruby/moderation/).
...
> [!NOTE]
> You can also find all available permissions on [Permissions Reference](/chat/docs/ruby/permissions_reference/) page
...
For grouping users into teams (or tenants) to keep their data strictly segregated, see [Multi-Tenancy](/chat/docs/ruby/multi_tenant_chat/).
